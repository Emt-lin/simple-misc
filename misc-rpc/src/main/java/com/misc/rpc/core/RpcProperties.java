...
public class RpcProperties extends HashMap<String, String > {
    ...
    public RpcProperties(Map<? extends String, ? extends String> map, Method method) {
        super(map);
        this.method = method;
    }
    ...
    public void setFallBackClass(Class<?> fallBackClass) {
        ...
        if(!flag) {
            throw new RpcException(String.format("RpcProperties setFallBackClass the " +
                    "fallBackClass must instance of %s", declaringClass));
        }
        ...
        try {
            ...
            throw new RpcException(String.format("RpcProperties setfallBackClass this %s new instance fail", fallBackClass));
        }
    }
    ...
    public Object getFallBack() {
        if(method == null) {
            throw new RpcException("RpcProperties getFallBack the method can not null");
        }
