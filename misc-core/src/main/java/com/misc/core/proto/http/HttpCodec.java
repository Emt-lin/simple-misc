...
public class HttpCodec extends ChannelDuplexHandler {
    ...
    public HttpCodec(MiscProperties properties, Map<Byte, MiscSerializableHandler> serializeHandlerMap) {
        this.type = properties.getByte(PropertiesConstant.CLIENT_SERIALIZABLE_TYPE,
                Constants.DEFAULT_SERIALIZABLE_TYPE.getCode());
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if(msg instanceof FullHttpRequest) {
            ...
            try {
                ...
                logger.error("[Misc-Server] Happened exception client-ip: {}, exception: {}.",
