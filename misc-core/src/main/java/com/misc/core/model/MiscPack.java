...
public class MiscPack implements Serializable {
    ...
    private static final long serialVersionUID = 1077776943193510396L;
    ...
    private String decodeRouter() {
        if(this.router == null) return ERROR;
        try {
    ...
    /**
     * {@link io.netty.channel.SimpleChannelInboundHandler#channelRead} 第112行
     * 这里会帮助我们release对象，释放内存
